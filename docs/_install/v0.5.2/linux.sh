...
if [ "$(uname -m)" = "x86_64" ]; then
    curl -L https://github.com/AFreeChameleon/multask/releases/download/v0.5.2/multask-linux_x86_64.tar.gz -s -o $PWD/mlt.tar.gz
elif [ "$(uname -m)" = "arm64" ]; then
    curl -L https://github.com/AFreeChameleon/multask/releases/download/v0.5.2/multask-linux_arm64.tar.gz -s -o $PWD/mlt.tar.gz
else
