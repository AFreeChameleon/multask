...
irm "https://raw.githubusercontent.com/AFreeChameleon/multask/refs/tags/v0.5.2/docs/_install/migration/check_migrations.ps1" | iex

# Downloading the exes
curl https://github.com/AFreeChameleon/multask/releases/download/v0.5.2/multask-windows_x86_64.zip -o "$env:USERPROFILE\mlt-win.zip" | Out-Null
